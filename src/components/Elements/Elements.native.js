          ...
          <div className="section-top-border">
            ...
            <div className="row">
              <div className="col-md-3">
                <img src="https://himalayafalooda.com.au/wp-content/uploads/2021/07/rainbow_cake_20402_16x9.jpg" alt="" className="img-fluid" data-pagespeed-url-hash="3197203439" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />
              </div>
            ...
            <div className="progress-table-wrap">
              <div className="progress-table">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f1.jpg" alt="flag" data-pagespeed-url-hash="2819903390" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f2.jpg" alt="flag" data-pagespeed-url-hash="3114403311" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f3.jpg" alt="flag" data-pagespeed-url-hash="3408903232" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f4.jpg" alt="flag" data-pagespeed-url-hash="3703403153" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f5.jpg" alt="flag" data-pagespeed-url-hash="3997903074" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f6.jpg" alt="flag" data-pagespeed-url-hash="4292402995" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f7.jpg" alt="flag" data-pagespeed-url-hash="291935620" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
                ...
                <div className="table-row">
                  ...
                  <div className="country"> <img src="../../imgelements/f8.jpg" alt="flag" data-pagespeed-url-hash="586435541" onload="pagespeed.CriticalImages.checkImageForCriticality(this);" />Canada</div>
                  <div className="visit">645032</div>
                  <div className="percentage">
                    <div className="progress">
